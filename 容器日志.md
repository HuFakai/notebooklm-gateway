...
INFO:     172.21.0.1:39660 - "GET /admin HTTP/1.1" 200 OK
INFO:     172.21.0.1:39662 - "GET /admin/api/accounts HTTP/1.1" 200 OK
INFO:     172.21.0.1:11868 - "GET /v1/notebooks HTTP/1.1" 200 OK
INFO:     172.21.0.1:38200 - "POST /v1/notebooks HTTP/1.1" 500 Internal Server Error
...
Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.11/site-packages/fastapi/dependencies/utils.py", line 678, in solve_dependencies
    solved = await call(**solved_result.values)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/gateway_server/notebooklm/server/_context.py", line 98, in get_client
    _sync_back_if_modified(client._auth.storage_path.parent.name)
  File "/app/gateway_server/notebooklm/server/_context.py", line 155, in _sync_back_if_modified
